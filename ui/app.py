...
MainApp._sync_ui_to_loaded_model = _app_model_chart_ops._sync_ui_to_loaded_model
MainApp._loaded_model_ui_meta = _app_model_chart_ops._loaded_model_ui_meta
MainApp._has_exact_model_artifacts = _app_model_chart_ops._has_exact_model_artifacts
MainApp._log_model_alignment_debug = _app_model_chart_ops._log_model_alignment_debug
MainApp._debug_chart_state = _app_model_chart_ops._debug_chart_state
MainApp._debug_candle_quality = _app_model_chart_ops._debug_candle_quality
MainApp._debug_forecast_quality = _app_model_chart_ops._debug_forecast_quality
MainApp._chart_prediction_caps = _app_model_chart_ops._chart_prediction_caps
MainApp._prepare_chart_predicted_prices = _app_model_chart_ops._prepare_chart_predicted_prices
MainApp._chart_prediction_uncertainty_profile = _app_model_chart_ops._chart_prediction_uncertainty_profile
MainApp._build_chart_prediction_bands = _app_model_chart_ops._build_chart_prediction_bands
MainApp._resolve_chart_prediction_series = _app_model_chart_ops._resolve_chart_prediction_series
MainApp._render_chart_state = _app_model_chart_ops._render_chart_state
MainApp._ensure_feed_subscription = _app_feed_ops._ensure_feed_subscription
MainApp._on_bar_from_feed = _app_feed_ops._on_bar_from_feed
MainApp._on_tick_from_feed = _app_feed_ops._on_tick_from_feed
MainApp._on_bar_ui = _app_feed_ops._on_bar_ui
MainApp._render_live_bar_update = _app_feed_ops._render_live_bar_update
MainApp._update_chart_latest_label = _app_feed_ops._update_chart_latest_label
MainApp._get_trained_stock_codes = _app_training_ops._get_trained_stock_codes
MainApp._sync_trained_stock_last_train_from_model = _app_training_ops._sync_trained_stock_last_train_from_model
MainApp._get_trained_stock_set = _app_training_ops._get_trained_stock_set
MainApp._is_trained_stock = _app_training_ops._is_trained_stock
MainApp._persist_session_bar = _app_training_ops._persist_session_bar
MainApp._submit_session_cache_write = _app_training_ops._submit_session_cache_write
MainApp._on_session_cache_write_done = _app_training_ops._on_session_cache_write_done
MainApp._shutdown_session_cache_writer = _app_training_ops._shutdown_session_cache_writer
MainApp._filter_trained_stocks_ui = _app_training_ops._filter_trained_stocks_ui
MainApp._pin_watchlist_symbol = _app_training_ops._pin_watchlist_symbol
MainApp._on_trained_stock_activated = _app_training_ops._on_trained_stock_activated
MainApp._refresh_trained_stock_list = _app_training_ops._refresh_trained_stock_list
MainApp._update_trained_stocks_ui = _app_training_ops._update_trained_stocks_ui
MainApp._focus_trained_stocks_tab = _app_training_ops._focus_trained_stocks_tab
MainApp._get_infor_trained_stocks = _app_training_ops._get_infor_trained_stocks
MainApp._train_trained_stocks = _app_training_ops._train_trained_stocks
MainApp._handle_training_drift_alarm = _app_training_ops._handle_training_drift_alarm
MainApp._quick_trade = _app_analysis_ops._quick_trade
MainApp._update_watchlist = _app_analysis_ops._update_watchlist
MainApp._on_watchlist_click = _app_analysis_ops._on_watchlist_click
MainApp._add_to_watchlist = _app_analysis_ops._add_to_watchlist
MainApp._remove_from_watchlist = _app_analysis_ops._remove_from_watchlist
MainApp._analyze_stock = _app_analysis_ops._analyze_stock
MainApp._on_analysis_done = _app_analysis_ops._on_analysis_done
MainApp._on_analysis_error = _app_analysis_ops._on_analysis_error
MainApp._update_details = _app_analysis_ops._update_details
MainApp._add_to_history = _app_analysis_ops._add_to_history
MainApp._signal_to_direction = _app_analysis_ops._signal_to_direction
MainApp._compute_guess_profit = _app_analysis_ops._compute_guess_profit
MainApp._refresh_guess_rows_for_symbol = _app_analysis_ops._refresh_guess_rows_for_symbol
MainApp._calculate_realtime_correct_guess_profit = _app_analysis_ops._calculate_realtime_correct_guess_profit
MainApp._update_correct_guess_profit_ui = _app_analysis_ops._update_correct_guess_profit_ui
MainApp._scan_stocks = _app_analysis_ops._scan_stocks
MainApp._on_scan_done = _app_analysis_ops._on_scan_done
