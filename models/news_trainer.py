...
- News sentiment analysis with self-trained embeddings
- Policy impact assessment
- Historical price patterns correlated with news
- Multi-modal learning (text + numerical data)

Architecture (Enhanced):
1. News Encoder: Lightweight transformer for self-trained text embeddings
...
Note: This uses self-training only - no pre-trained models (BERT/FinBERT) are loaded.
All embeddings are learned from your data during training.
"""
...
class NewsEncoder(nn.Module):
    """Transformer-based encoder for news text (self-trained).

    This is the primary news encoder - all embeddings are learned
    from your data during training. No pre-trained models are used.
    """
