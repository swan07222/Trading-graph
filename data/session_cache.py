...
def _is_session_timestamp(ts_raw: str, interval: str) -> bool:
    ...
    try:
        ...
        log.warning("Timezone conversion failed for session check: %s", e)
    ...
    try:
        ...
        log.warning("Session datetime check failed: %s", e)
        return False
    ...
    try:
        ...
        if acquired:
            try:
                ...
                log.warning("Failed to release file lock: %s", e)
        try:
            f.close()
        except OSError as e:
            log.warning("Failed to close lock file: %s", e)
        ...
        *,
        ...
        with path.open(mode, encoding="utf-8", newline="") as f:
            ...
            try:
                ...
                pass
    @staticmethod
    def _to_shanghai_naive_datetime(value: Any) -> datetime | None:
